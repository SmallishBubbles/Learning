...
/*
  ...
  Hash tables are a way to keep track of information and have a super fast lookup time. 
  The quality of the hashing algorithm is super important so that there are no overlapping values.
  There should also be a steady hash generation so that the same input produces the same result whenever it is called.
  Hash tables do not keep track of order.
